...
def main(args=None):
    try:
        ...
        ColorMsg(msg=f"embedded_version: {embedded_version}, hand_joint: {node.hand_joint}", color="green")
        if embedded_version is None or node.hand_joint.upper() == "O6" or node.hand_joint.upper() == "L6" or node.hand_joint.upper() == "G20":
